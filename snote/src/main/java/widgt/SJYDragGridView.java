 ...
 *
 */
public class SJYDragGridView extends GridView {
    ...
    public SJYDragGridView(Context context) {
        this(context, null);
    }

    public SJYDragGridView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SJYDragGridView(Context context, AttributeSet attrs, int defStyle) {
