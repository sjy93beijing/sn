...
//        saveUserHeadUrl(context, user.getUserHeadUrl());
    ...
    public static String getUserName(Context context) {
        return (String) SP.get(context, USER_NAME, "");
    }

    public static void saveUserName(Context context, String str) {
        SP.put(context, USER_NAME, str);
    }

    public static String getUserPwd(Context context) {
        return (String) SP.get(context, USER_PWD, "");
    }

    public static void saveUserPwd(Context context, String str) {
        SP.put(context, USER_PWD, str);
    }

    public static String getUserId(Context context) {
        return (String) SP.get(context, USER_ID, "");
    }

    public static void saveUserId(Context context, String str) {
        SP.put(context, USER_ID, str);
    }

    public static String getUserEmail(Context context) {
        return (String) SP.get(context, USER_EMAIL, "");
    }

    public static void saveUserEmail(Context context, String str) {
        if (!TextUtils.isEmpty(str)) {
            SP.put(context, USER_EMAIL, str);
        }
    }

    public static String getUserNickName(Context context) {
        return (String) SP.get(context, USER_NICK_NAME, "");
    }

    public static void saveUserNickName(Context context, String str) {
        SP.put(context, USER_NICK_NAME, str);
    }

    public static String getUserDiaryPwd(Context context) {
        return (String) SP.get(context, USER_NOTE_PWD, "");
    }

    public static void saveUserDiaryPwd(Context context, String str) {
        SP.put(context, USER_NOTE_PWD, str);
    }

    public static String getUserSex(Context context) {
        return (String) SP.get(context, USER_SEX, "");
    }

    public static void saveUserSex(Context context, String str) {
        SP.put(context, USER_SEX, str);
    }

    public static String getUserHeadUrl(Context context){
        return (String) SP.get(context, USER_HEAD_URL, "");
    }


    public static void saveUserHeadUrl(Context context, String str) {
        SP.put(context, USER_HEAD_URL, str);
    }
